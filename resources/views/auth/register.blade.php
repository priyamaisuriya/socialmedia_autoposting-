...
<head>
    ...
    <title>FB Manager - Register</title>
            ...
            <div class="register-box">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required autofocus class="premium-input" placeholder="John Doe">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirmation" required class="premium-input" placeholder="••••••••">
                        </div>
                    </div>

                    <button type="submit" class="btn-premium" style="width: 100%; margin-top: 8px; padding: 1rem; font-size: 1.1rem; justify-content: center;">Create Account</button>
